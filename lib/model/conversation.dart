import 'package:flutter_ty_demo/utils/sql.dart';
import 'package:flutter_ty_demo/utils/util.dart';
...
class ConversationControlModel{
  ...
  Future insert(Conversation conversation) async{
    var response = await sql.insert({'avatar': conversation.avatar,
...
List<Conversation> preConversation = [
  ...
  const Conversation(avatar: 'static/images/zushou.jpg', title: '文件传输助手', createAt: '08:12',
      describtion: ''),
  const Conversation(avatar: 'static/images/xinwen.jpg', title: '腾讯新闻', createAt: '12:09',
      describtion: '微视频：人民代表xxx履职记'),
  const Conversation(avatar: 'static/images/dianxin.jpg', title: '中国电信', createAt: '14:01',
      describtion: '月度账单提醒', unReadMsgCount: 1),
];
